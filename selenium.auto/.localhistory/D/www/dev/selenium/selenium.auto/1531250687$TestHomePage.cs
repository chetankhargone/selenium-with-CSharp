...
namespace selenium.auto
{
    ...
    /// </summary>
    [TestClass]
    public class TestHomePage : Base<ChromeDriver>
    {
        #region Private
        ...
        #region Ctor
        public TestHomePage(ChromeDriver driver)
        ...
        public void TestLogin()
        {
            ...
            Assert.AreEqual(expected: "https://selenium-kgn.azurewebsites.net/Home/Login", actual: actionUrl);
            TearDown();
        }
